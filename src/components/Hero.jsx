  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 pt-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        {/* Title */}
        <h1 className="reveal opacity-0 text-5xl md:text-7xl font-black tracking-tight leading-tight mb-6">
          {t.hero.title}{' '}
        ...
        <div className="reveal opacity-0 flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl border border-black/15 dark:border-white/15 bg-black/5 dark:bg-white/5 text-zinc-600 dark:text-zinc-300 font-semibold text-base hover:bg-black/10 dark:hover:bg-white/10 transition-all duration-300 active:scale-95"
          >
            {t.hero.ctaSecondary}
          </button>
        </div>
